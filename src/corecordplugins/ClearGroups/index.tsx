...
async function clearAllGroups() {
    ...
    if (channels.length === 0) {
        showToast("No groups to leave", Toasts.Type.MESSAGE);
        return;
    }
    ...
    Alerts.show({
        ...
        body: (
            <div style={{ color: "#dbdee1" }}>
                Are you sure you want to leave all your group DMs? This will remove you from all group conversations.
            </div>
        ),
        onConfirm: async () => {
            showToast(`Leaving ${channels.length} groups...`, Toasts.Type.MESSAGE);
            let leftCount = 0;
