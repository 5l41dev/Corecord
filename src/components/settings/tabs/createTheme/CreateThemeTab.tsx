        ...
        <div className={cl("root")}>
            ...
            <div className={cl("card")}>
                <div className={cl("header-group")}>
                    <div className={cl("card-title")}>Theme Color</div>
                    <div className={cl("card-desc")}>Customize the tint color across all Discord panels, headers, and UI elements.</div>
                </div>

                <div className={cl("color-picker-row")}>
                    <div className={cl("color-info")}>
                        <div className={cl("color-title")}>Primary Accent</div>
                        <div className={cl("color-sub")}>Tints panels, sidebar, buttons, and accents</div>
                    </div>
                ...
                <div className={cl("presets-section")}>
                    <div className={cl("presets-label")}>Color Presets</div>
                ...
                {(contrastWarning || nitroThemeEnabled) && (
                    <ErrorCard className={Margins.top8}>
                        <div style={{ fontWeight: 700, marginBottom: 4 }}>Contrast Warning</div>
                        {contrastWarning && <Paragraph>› Selected color may not contrast well with text</Paragraph>}
                        {nitroThemeEnabled && <Paragraph>› Nitro themes are not supported with custom color tinting</Paragraph>}
            ...
            <div className={cl("card")}>
                <FormSwitch
                    title="Enable Theme"
                    description="When enabled, your custom theme stays active even after closing settings or restarting Discord."
